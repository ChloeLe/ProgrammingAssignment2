...
## set the value of the inverse using function solve
## get the value of the inverse using function solve
...
created with the above function. However, it first checks to see if the inverse has already 
